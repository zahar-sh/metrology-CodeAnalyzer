...
public class Tokenizer {
    ...
    public static final String beginComments = "/*";
    public static final String endComments = "*/";
    ...
    public Token nextToken() {
        while (true) {
            ...
            if (canRead()) {
                ...
                if (ch == '/') {
                    int n = cursor + 1;
                    if (n < code.length() && code.charAt(n) == '/') {
                ...
                int l = code.length();
                int end = cursor < l ? cursor : l - 1;
                return new Token(code.substring(start, end), start);
            } else {
    ...
    public void forEach(Consumer<Token> consumer) {
        Token token;
        while ((token = nextToken()).string != null)
